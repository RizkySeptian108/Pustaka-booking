						...
						<tr>
							...
							<td>
								<picture>
									...
									<img src="<?= base_url('asset/img/upload/') . $b['image'];?>" class="img-fluid img-thumbnail" alt="...">
								</picture>
							</td>
							<td>
								...
								<a href="<?= base_url('buku/hapusbuku/').$b['id'];?>" onclick="return confirm('Kamu yakin akan menghapus buku <?= $b['judul_buku'];?> ?');" class="badge badge-danger">
...
<div class="modal fade" id="bukuBaruModal" tab-index="-1" role="dialog" aria-labelledby="bukuBaruModalLabel" aria-hidden="true">
