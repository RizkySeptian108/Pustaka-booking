		...
		<div class="x_content">
			...
			<div class="row">
				...
				<div class="col-md-2 col-md-3">
					<div class="thumbnail text-center bordered" style="height: 370px;">
						<img src="<?php echo base_url(); ?>asset/img/upload/<?= $buku->image; ?>" style="max-width:100%; max-height: 100%; height: 200px; width: 180px">
						<div class="caption">
